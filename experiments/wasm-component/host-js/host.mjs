...
const vectors = [
  ['ru', 'dg-04', 'оставила окно открытым', (r) => r.ok?.quote === 'оставила окно открытым'
  ...
  ['en', 'dg-04', 'оставила окно открытым', (r) => r.err?.tag === 'not-exact-span',  'RU span is not a span of the EN presentation'],
