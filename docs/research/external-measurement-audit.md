...
| Есть ли в perceived impact то, чего нет в сообщении? | **Да.** Рандомизированная метка об авторстве сдвигает отчёт на 0.69 балла из 7 (p = 0.0010, n = 221) |
...
| Отслеживают ли стороны одно и то же? | **Нет.** Люди-наблюдатели отслеживают длину ответа сильнее, чем отчёт получателя: разность τ_b +0.44 [+0.23, +0.64] |
