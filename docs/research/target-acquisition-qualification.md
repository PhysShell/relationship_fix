...
tdesktop history-fetch source     ✔ цепочка прослежена; 2 свойства QUALIFIED,
        ...
        ↓
public result.json attachments    ← ИДЁТ: 3 скачанных файла, 235 записей,
                                    0 контрпримеров, 0 засчитанных строк
                                    целевого типа. Побочно закрыл
                                    `time.local_string`; найден первый
                                    cross-actor tie
        ↓
