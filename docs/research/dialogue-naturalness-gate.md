...
**Статус donor path: 13/13 donor candidates accepted · 0 pending facilitator verdicts · v0.1 not built · human naturalness evidence: none · next gate: explicit v0.1 build/cutover.** Сборка — отдельная работа с отдельным «го»: четыре replacement, retirement, новые ids, lineage, dogfood/Catalog cutover дают достаточно мест, где можно аккуратно соврать самому себе; «собрать как очевидно» не разрешено.
